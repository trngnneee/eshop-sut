...
- Name: forgot-password.spec.js >> FR-03 · Forgot Password — Step 2: Password BVA >> TC-FORGOT-032 · BVA · New password length 9 (min+) → reset succeeds
- Location: tests\e2e\forgot-password.spec.js:298:3
...
- generic [ref=e3]:
  ...
  - main [ref=e10]:
    - generic [ref=e11]:
      ...
      - generic [ref=e13]:
        - generic [ref=e14]: "Mã OTP của bạn là: 4162"
        - generic [ref=e15]:
          - generic [ref=e16]: Mã OTP (4 số)
          - textbox [ref=e17]: "4162"
        - generic [ref=e18]:
