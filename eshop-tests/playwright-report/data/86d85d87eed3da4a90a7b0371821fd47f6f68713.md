...
- Name: forgot-password.spec.js >> FR-03 · Forgot Password — Step 2: Confirm-password BVA >> TC-FORGOT-036 · BVA · Confirm password length 7 (min−) → rejected
- Location: tests\e2e\forgot-password.spec.js:330:3
...
- generic [ref=e3]:
  ...
  - main [ref=e10]:
    - generic [ref=e11]:
      ...
      - generic [ref=e13]:
        - generic [ref=e14]: "Mã OTP của bạn là: 2773"
        - generic [ref=e15]:
          - generic [ref=e16]: Mã OTP (4 số)
          - textbox [ref=e17]: "2773"
        - generic [ref=e18]:
