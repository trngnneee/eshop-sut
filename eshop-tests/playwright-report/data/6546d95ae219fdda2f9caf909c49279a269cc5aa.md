...
- Name: forgot-password.spec.js >> FR-03 · Forgot Password — Step 2: Confirm-password BVA >> TC-FORGOT-041 · BVA · Confirm password length 51 (max+) → rejected
- Location: tests\e2e\forgot-password.spec.js:365:3
...
- generic [ref=e3]:
  ...
  - main [ref=e10]:
    - generic [ref=e11]:
      ...
      - generic [ref=e13]:
        - generic [ref=e14]: "Mã OTP của bạn là: 5277"
        - generic [ref=e15]:
          - generic [ref=e16]: Mã OTP (4 số)
          - textbox [ref=e17]: "5277"
        - generic [ref=e18]:
