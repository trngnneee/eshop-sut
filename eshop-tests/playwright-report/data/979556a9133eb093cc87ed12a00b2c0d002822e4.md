...
- Name: forgot-password.spec.js >> FR-03 · Forgot Password — Step 1: Email domain & BVA >> TC-FORGOT-026 · BVA · Email length 101 (max+) → length error
- Location: tests\e2e\forgot-password.spec.js:146:3
    ...
    - generic [ref=e11]:
      ...
      - generic [ref=e13]:
        - generic [ref=e14]:
          ...
          - textbox [ref=e16]: aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa
...
```ts
  36  |       'form [class*="error"], form [class*="alert-danger"], form [role="alert"]'
  37  |     );
  38  |     this.successMsg = page.locator(
  39  |       '[class*="success"], text=/thành công/i, text=/success/i'
  40  |     );
  41  |     this.otpDemoBox = page.locator('[class*="green"], [class*="otp"]');
  42  |   }
  43  | 
