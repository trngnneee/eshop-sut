...
- Name: forgot-password.spec.js >> FR-03 · Forgot Password — Happy path & UI >> TC-FORGOT-001 · DT · Full valid reset → login with new password succeeds
- Location: tests\e2e\forgot-password.spec.js:51:3

# Error details

```
Error: Step 2 must include confirm-password field (FR-03)
...
- generic [ref=e3]:
  ...
  - main [ref=e10]:
    - generic [ref=e11]:
      ...
      - generic [ref=e13]:
        - generic [ref=e14]: "Mã OTP của bạn là: 9575"
        - generic [ref=e15]:
