...
- Name: forgot-password.spec.js >> FR-03 · Forgot Password — Happy path & UI >> TC-FORGOT-019 · GUI · Step Indicator shows correct step (Bước 1/2 → Bước 2/2)
- Location: tests\e2e\forgot-password.spec.js:62:3

# Error details

```
Error: Step 1 must show Step Indicator (FR-03)
