...
- Name: forgot-password.spec.js >> FR-03 · Forgot Password — Step 2: Password BVA >> TC-FORGOT-035 · BVA · New password length 51 (max+) → rejected
- Location: tests\e2e\forgot-password.spec.js:319:3
...
- generic [ref=e3]:
  ...
  - main [ref=e10]:
    - generic [ref=e11]:
      ...
      - generic [ref=e13]:
        - generic [ref=e14]: "Mã OTP của bạn là: 4868"
        - generic [ref=e15]:
          - generic [ref=e16]: Mã OTP (4 số)
          - textbox [ref=e17]: "4868"
        - generic [ref=e18]:
          - generic [ref=e19]: Mật khẩu mới
          - textbox [ref=e20]: Aa1!xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
