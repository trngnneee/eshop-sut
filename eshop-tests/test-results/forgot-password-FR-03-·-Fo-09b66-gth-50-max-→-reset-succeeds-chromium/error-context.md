...
- Name: forgot-password.spec.js >> FR-03 · Forgot Password — Step 2: Password BVA >> TC-FORGOT-034 · BVA · New password length 50 (max) → reset succeeds
- Location: tests\e2e\forgot-password.spec.js:312:3
