...
- Name: forgot-password.spec.js >> FR-03 · Forgot Password — Step 2: Confirm-password BVA >> TC-FORGOT-039 · BVA · Confirm password length 49 (max−) → reset succeeds
- Location: tests\e2e\forgot-password.spec.js:351:3
...
- generic [ref=e3]:
  ...
  - main [ref=e10]:
    - generic [ref=e11]:
      ...
      - generic [ref=e13]:
        - generic [ref=e14]: "Mã OTP của bạn là: 6081"
        - generic [ref=e15]:
          - generic [ref=e16]: Mã OTP (4 số)
          - textbox [ref=e17]: "6081"
        - generic [ref=e18]:
          - generic [ref=e19]: Mật khẩu mới
          - textbox [ref=e20]: Aa1!xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
