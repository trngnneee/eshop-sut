...
- Name: forgot-password.spec.js >> FR-03 · Forgot Password — Step 2: Confirm-password BVA >> TC-FORGOT-038 · BVA · Confirm password length 9 (min+) → reset succeeds
- Location: tests\e2e\forgot-password.spec.js:344:3
...
- generic [ref=e3]:
  ...
  - main [ref=e10]:
    - generic [ref=e11]:
      ...
      - generic [ref=e13]:
        - generic [ref=e14]: "Mã OTP của bạn là: 8781"
        - generic [ref=e15]:
          - generic [ref=e16]: Mã OTP (4 số)
          - textbox [ref=e17]: "8781"
        - generic [ref=e18]:
          - generic [ref=e19]: Mật khẩu mới
          - textbox [ref=e20]: Abc@12345
