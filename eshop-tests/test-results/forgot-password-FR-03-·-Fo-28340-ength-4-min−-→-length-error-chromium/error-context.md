...
- Name: forgot-password.spec.js >> FR-03 · Forgot Password — Step 1: Email domain & BVA >> TC-FORGOT-021 · BVA · Email length 4 (min−) → length error
- Location: tests\e2e\forgot-password.spec.js:115:3
