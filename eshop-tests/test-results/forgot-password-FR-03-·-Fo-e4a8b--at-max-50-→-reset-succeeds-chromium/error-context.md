...
- Name: forgot-password.spec.js >> FR-03 · Forgot Password — Cross-boundary BVA >> TC-FORGOT-043 · BVA · Both passwords at max (50) → reset succeeds
- Location: tests\e2e\forgot-password.spec.js:383:3
...
- generic [ref=e3]:
  ...
  - main [ref=e10]:
    - generic [ref=e11]:
      ...
      - generic [ref=e13]:
        - generic [ref=e14]: "Mã OTP của bạn là: 2844"
        - generic [ref=e15]:
          - generic [ref=e16]: Mã OTP (4 số)
          - textbox [ref=e17]: "2844"
        - generic [ref=e18]:
