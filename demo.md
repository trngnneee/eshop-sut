...
| 23127458 | Phan Quốc Thịnh      | Loader.io, Siege, Vegeta                        | Tìm hiểu hướng ứng dụng AI vào quá trình kiểm thử; Sử dụng AI để tạo script k6 từ Workload Model có sẵn; AI Audit                                                          |
...
|  10 | **wrk**            | HTTP benchmarking tốc độ cao trên máy đa lõi; tạo lượng request lớn đến một hoặc một số endpoint.                                           | **Miễn phí, mã nguồn mở.**                                                                                                                                                   | CLI và LuaJIT cho request ge                                                                     |
...
## 8.1. Lý do 1 — Phù hợp trực tiếp với EShop và mục tiêu T05
...
flowchart TD
    ...
    B["k6 Engine"]
    C["Virtual Users (VUs)"]
    D["HTTP Requests gửi đến hệ thống"]
    E["System Under Test"]
    F["Thu thập Metrics và tạo Report"]
...
## 12.2. So sánh thực nghiệm

> Điền sau khi có dữ liệu.

| Tiêu chí               | JMeter |    k6 | Nhận xét có evidence     |
| ---------------------- | -----: | ----: | ------------------------ |
| Setup time             |  `[ ]` | `[ ]` | `[ ]`                    |
...
| Error rate             |  `[ ]` | `[ ]` | `[ ]`                    |
| Load generator CPU     |  `[ ]` | `[ ]` | `[ ]`                    |
| Maintainability rating |  `[ ]` | `[ ]` | Rubric nội bộ + evidence |

## 17.3. Khuyến nghị theo bối cảnh
...
| ----------- | ------------ | -------------------------------------------- | ------------------------------------ | -------------- | --------------------------------------------------------- |
| ChatGPT     | `[CẦN ĐIỀN]` | Xây dựng outline/report và câu hỏi phản biện | Course documents + danh sách 15 tool | Draft Markdown | Cross-check với Seminar Guide, T05 brief và official docs |
