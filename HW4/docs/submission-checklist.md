...
| 8   | Bug report + GitHub Issue screenshots            | ✅ Done            | `HW4/docs/bug-report-{login,cart,dashboard}.md` - all 19 new bugs filed as real Issues [#318–#329](https://github.com/trngnneee/eshop-sut/issues?q=is%3Aissue+318..329+in%3Anumber) + [#333–#339](https://github.com/trngnneee/eshop-sut/issues?q=is%3Aissue+333..339+in%3Anumber) with screenshot evidence attached. The 31 already-known bugs also have a rendered evidence screenshot each (linked inline from each bug-report table/entry), so all 50 bugs total have local evidence in `HW4/docs/bug-evidence/` (19 also attached to their GitHub Issue; the 31 known ones link to pre-existing HW02 issues that predate this run) |
...
The 31 already-known bugs this run reproduced were mostly already filed in HW02
