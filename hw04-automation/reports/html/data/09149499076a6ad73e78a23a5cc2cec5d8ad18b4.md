...
Locator:  locator('div.w-full.md\\:w-2\\/3.bg-white').filter({ has: getByRole('heading', { name: 'Lịch sử đơn hàng', level: 2 }) }).first().locator('table').first().locator('tbody tr').filter({ has: locator('td').filter({ hasText: '#34' }) }).locator('td').nth(2)
Expected: "125.000 ₫"
Received: "125,000 ₫"
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('div.w-full.md\\:w-2\\/3.bg-white').filter({ has: getByRole('heading', { name: 'Lịch sử đơn hàng', level: 2 }) }).first().locator('table').first().locator('tbody tr').filter({ has: locator('td').filter({ hasText: '#34' }) }).locator('td').nth(2)
    13 × locator resolved to <td class="p-2 text-red-600 font-bold">125,000 ₫</td>
