...
| 3 | API-3 full pipeline | 30 | Matrix/generation/extend/execute complete; human sign-off + external evidence còn thiếu | 23 |
...
Điểm 100 chỉ có thể tự tin nộp sau khi hoàn tất các gate bắt buộc của đề: ký API-3 audit, tạo GitHub Issues + screenshot, chụp Postman Console/Newman/CI, tự vẽ `test-generator/diagram.png`, viết lại critique bằng lời của người học, xuất PDF, đặt repo public và đóng zip đúng tên.
...
- [ ] API-3 `02-audit.md` có chữ ký người học.
...
- [ ] Một GitHub Issue + screenshot cho mỗi defect.
