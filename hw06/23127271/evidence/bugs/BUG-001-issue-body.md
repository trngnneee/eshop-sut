...
- **Severity:** Critical
- **Found via:** `TC-ADMINUSERS-SEC-SUP-002` (Human (Stage 3))
- **Branch:** `HW6-Tram`

## Screenshot evidence

![BUG-001 evidence](https://github.com/trngnneee/eshop-sut/raw/HW6-Tram/hw06/23127271/evidence/bugs/BUG-001.png)
