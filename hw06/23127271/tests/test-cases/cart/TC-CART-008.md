# TC-CART-008: id=0 — not specified as invalid
...
## Test steps
1. POST /api/cart with id=0 and other fields valid.
2. GET /api/cart.
...
## Sub-domains covered
C-ID-03, C-QTY-02, C-PRICE-01, C-NAME-01, C-AUTH-01
...
## Audit
- **Status:** INVALID
- **Reasoning:** No rule says product id must be > 0 or exist in the catalogue.
