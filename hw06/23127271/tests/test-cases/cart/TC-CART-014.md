# TC-CART-014: id='abc' — not specified as invalid
...
## Test steps
1. POST /api/cart with id="abc" and other fields valid.
2. GET /api/cart.
...
## Sub-domains covered
C-ID-10, C-QTY-02, C-PRICE-01, C-NAME-01, C-AUTH-01
...
## Audit
- **Status:** INVALID
- **Reasoning:** Non-numeric id is not specified as invalid.
