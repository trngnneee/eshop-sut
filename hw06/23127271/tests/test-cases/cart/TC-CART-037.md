# TC-CART-037: JSON array body — rejection not specified
...
## Test steps
1. POST /api/cart with a JSON array of items instead of one object.
...
## Audit
- **Status:** INVALID
- **Reasoning:** A JSON array is not stated as a rejected shape.
