# TC-CART-024: Negative price — not specified as invalid for this API
...
## Audit
- **Status:** INVALID
- **Reasoning:** Negative cart price is not specified. FR-15 is the product-admin rule.
