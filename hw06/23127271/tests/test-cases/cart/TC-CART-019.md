# TC-CART-019: quantity=1.5 — not specified as invalid
...
## Test steps
1. POST /api/cart with quantity=1.5 and other fields valid.
2. GET /api/cart.
...
## Sub-domains covered
C-QTY-07, C-ID-01, C-PRICE-01, C-NAME-01, C-AUTH-01
...
## Audit
- **Status:** INVALID
- **Reasoning:** Non-integer quantity is not specified for this API.
