# TC-CART-017: Negative quantity — not specified as invalid for this API
...
## Test steps
1. POST /api/cart with quantity=-1 and other fields valid.
2. GET /api/cart.
...
## Sub-domains covered
C-QTY-05, C-ID-01, C-PRICE-01, C-NAME-01, C-AUTH-01
...
## Audit
- **Status:** INVALID
- **Reasoning:** Negative quantity is not specified for POST /api/cart. FR-06 is product-detail UI.
