# TC-CART-013: id=1.5 — not specified as invalid
...
## Test steps
1. POST /api/cart with id=1.5 and other fields valid.
2. GET /api/cart.
...
## Sub-domains covered
C-ID-09, C-QTY-02, C-PRICE-01, C-NAME-01, C-AUTH-01
...
## Audit
- **Status:** INVALID
- **Reasoning:** Non-integer id is not specified as invalid.
