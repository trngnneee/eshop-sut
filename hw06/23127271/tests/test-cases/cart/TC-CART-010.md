# TC-CART-010: Non-existent product id — not specified as invalid
...
## Test steps
1. POST /api/cart with id=99999 and other fields valid.
2. GET /api/cart.
...
## Sub-domains covered
C-ID-05, C-QTY-02, C-PRICE-01, C-NAME-01, C-AUTH-01
...
## Audit
- **Status:** INVALID
- **Reasoning:** The spec does not require id to reference an existing product.
