# TC-PROFILE-022: Reject phone with leading whitespace
...
## Test steps
1. PUT /api/users/me with phone= 0912345678 and other fields valid.
2. GET /api/users/me.
...
## Sub-domains covered
P-PHONE-11, P-NAME-01, P-ADDR-01, P-AUTH-01
...
## Audit
- **Status:** INCOMPLETE
- **Reasoning:** A leading space means the value does not start with 0. HTTP 400 is not specified.
