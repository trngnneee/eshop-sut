# TC-PROFILE-031: Reject malformed JWT
...
## Test steps
1. PUT /api/users/me with Authorization: Bearer not-a-jwt and valid body.
...
## Audit
- **Status:** INCOMPLETE
- **Reasoning:** Malformed token is not a valid JWT (SEC-02). HTTP 403/401 is not specified.
