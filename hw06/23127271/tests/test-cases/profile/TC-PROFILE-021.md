# TC-PROFILE-021: Reject +84 international phone
...
## Test steps
1. PUT /api/users/me with phone=+84912345678 and other fields valid.
2. GET /api/users/me.
...
## Sub-domains covered
P-PHONE-10, P-NAME-01, P-ADDR-01, P-AUTH-01
...
## Audit
- **Status:** INCOMPLETE
- **Reasoning:** +84… does not start with 0. HTTP 400 is not specified.
