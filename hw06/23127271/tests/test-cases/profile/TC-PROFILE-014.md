# TC-PROFILE-014: Reject 9-digit phone (min−1)
...
## Test steps
1. PUT /api/users/me with phone=091234567 and other fields valid.
2. GET /api/users/me.
...
## Sub-domains covered
P-PHONE-03, P-NAME-01, P-ADDR-01, P-AUTH-01
...
## Audit
- **Status:** INCOMPLETE
- **Reasoning:** 9 digits is outside FR-04's 10–11. The generated HTTP 400 is not specified.
