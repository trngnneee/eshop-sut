# TC-PROFILE-025: Empty shipping_address — not specified as invalid
...
## Test steps
1. PUT /api/users/me with empty shipping_address.
2. GET /api/users/me.
...
## Audit
- **Status:** INVALID
- **Reasoning:** No non-empty rule is stated for shipping_address.
