# TC-PROFILE-023: Reject phone=null
...
## Test steps
1. PUT /api/users/me with phone JSON null.
2. GET /api/users/me.
...
## Audit
- **Status:** INCOMPLETE
- **Reasoning:** If phone is sent, FR-04's valid form applies; null is not that form. Generated HTTP 400 is not specified.
