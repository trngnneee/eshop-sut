# TC-PROFILE-008: Empty name — not specified as invalid
...
## Sub-domains covered
P-NAME-03, P-PHONE-01, P-ADDR-01, P-AUTH-01
...
## Audit
- **Status:** INVALID
- **Reasoning:** FR-14 says category name cannot be empty; FR-04 never says name cannot be empty. Empty name was treated as invalid by assumption.
