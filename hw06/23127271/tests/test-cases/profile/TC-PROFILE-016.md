# TC-PROFILE-016: Reject phone not starting with 0
...
## Test steps
1. PUT /api/users/me with phone=1912345678 and other fields valid.
2. GET /api/users/me.
...
## Sub-domains covered
P-PHONE-05, P-NAME-01, P-ADDR-01, P-AUTH-01
...
## Audit
- **Status:** INCOMPLETE
- **Reasoning:** Does not start with 0, so it is not a valid FR-04 phone. HTTP 400 is not specified.
