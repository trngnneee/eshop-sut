# TC-PROFILE-019: Reject phone containing letters
...
## Test steps
1. PUT /api/users/me with phone=09ab345678 and other fields valid.
2. GET /api/users/me.
...
## Sub-domains covered
P-PHONE-08, P-NAME-01, P-ADDR-01, P-AUTH-01
...
## Audit
- **Status:** INCOMPLETE
- **Reasoning:** FR-04 requires digits (chữ số). Letters are outside that set. HTTP 400 is not specified.
