# TC-PROFILE-020: Reject phone with separators
...
## Test steps
1. PUT /api/users/me with phone=0912-345-678 and other fields valid.
2. GET /api/users/me.
...
## Sub-domains covered
P-PHONE-09, P-NAME-01, P-ADDR-01, P-AUTH-01
...
## Audit
- **Status:** INCOMPLETE
- **Reasoning:** Separators are not 10–11 digits. HTTP 400 is not specified.
