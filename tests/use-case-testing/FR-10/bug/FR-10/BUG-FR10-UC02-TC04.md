## BUG-FR10-UC02-TC04 - User có thể hủy đơn hàng đang shipping
...
- `FR10-UC02-TC04`
- Path: `eshop-sut/use-case-testing/FR-10/test-cases/order_state_machine/FR10-UC02-TC04.md`

## Requirement liên quan

- `FR-10`
- User không được phép tự hủy đơn hàng khi đơn đang `shipping`.
...
1. Chuẩn bị fixture/order đúng precondition của `FR10-UC02-TC04`.
