# TC-MFORGOT-040: Kiểm thử Xác nhận mật khẩu với độ dài biên tối đa (50 ký tự)
...
## Boundary under test
Xác nhận mật khẩu at max — value: 50 ký tự (`Aa1!` + 46 ký tự `x`)
...
2. Nhập OTP hợp lệ.
3. Nhập Mật khẩu mới và Xác nhận mật khẩu đều có độ dài 50 ký tự và khớp nhau.
