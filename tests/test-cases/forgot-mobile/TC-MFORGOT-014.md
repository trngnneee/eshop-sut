# TC-MFORGOT-014: Kiểm thử Mật khẩu mới thiếu chữ thường
...
2. Nhập OTP hợp lệ.
3. Nhập Mật khẩu mới `TEST1234!` (không có chữ thường) và Xác nhận mật khẩu khớp.
4. Bấm "Đặt lại mật khẩu".

## Expected result
- Hệ thống từ chối vì mật khẩu thiếu ít nhất 1 chữ thường (theo FR-01).
- Mật khẩu không được thay đổi.

## Sub-domains covered
SD-P04 (thiếu chữ thường)
