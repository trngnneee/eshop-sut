# TC-PROFILE-005: Cập nhật hồ sơ thất bại do Họ Tên chứa số
...
## Test data
name: "Nguyen Van A 123", shipping_address: "123 Duong Le Loi, Q1, HCM", phone: "0912345678"

## Test steps
**Cách 1: Gửi request API:**
1. Gửi yêu cầu PUT đến /api/users/me với name chứa chữ số.
...
## Expected result
- Trả về HTTP 400 Bad Request. Báo lỗi Họ Tên không hợp lệ (không được chứa số).

## Status / Related bugs
Fail / [BUG-PROFILE-005](../../bug-reports/BUG-PROFILE-005.md)
