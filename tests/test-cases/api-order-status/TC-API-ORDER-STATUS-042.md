# TC-API-ORDER-STATUS-042

- Requirement: `FR-10/FR-12/FR-18`
- Group/technique: Extension / State/security
- Preconditions: Admin JWT; order shipping; status=canceled
- Method/data: `Admin hủy đơn shipping`
- Expected: 200; order chuyển canceled
- Result: FAIL — defect expected
- Related Bug: [#425](https://github.com/trngnneee/eshop-sut/issues/425) (`D-ADM-03`)
