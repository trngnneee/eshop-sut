...
Kiểm tra ứng dụng mobile ẩn/không hiển thị nút Hủy đơn hàng khi đơn hàng ở trạng thái `shipping`. Theo FR-10 và FR-20, User không được phép hủy đơn đang giao.
