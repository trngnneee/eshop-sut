...
Kiểm tra ứng dụng mobile hiển thị nút Hủy đơn hàng khi đơn hàng ở trạng thái `confirmed`. Theo FR-20, User được phép hủy đơn khi trạng thái là `confirmed`.
...
- Nút Hủy đơn hàng HIỂN THỊ rõ ràng trên giao diện chi tiết đơn hàng khi trạng thái là `confirmed`.
