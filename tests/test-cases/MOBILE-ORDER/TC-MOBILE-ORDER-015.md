...
Kiểm tra trạng thái `confirmed` được hiển thị bằng tiếng Việt rõ ràng trên ứng dụng mobile. Theo FR-11, trạng thái phải được dịch sang tiếng Việt.
...
- User có ít nhất 1 đơn hàng ở trạng thái `confirmed`.
...
| Parameter | Value |
|-|-|
| Trạng thái backend | confirmed |
| Trạng thái hiển thị kỳ vọng | Tiếng Việt (VD: "Đã xác nhận") |
...
3. Tìm đơn hàng có trạng thái `confirmed`.
