...
Kiểm tra Admin có thể chuyển đơn hàng từ trạng thái `confirmed` sang `shipping`.
...
4. Thực hiện thao tác chuyển trạng thái sang `shipping`
...
- Giao diện hiển thị trạng thái mới là `shipping`
- Hệ thống trả về thành công (HTTP 200)

## Actual Result

Hệ thống chấp nhận yêu cầu, cập nhật thành công trạng thái đơn hàng sang `shipping` và trả về mã HTTP 200.
