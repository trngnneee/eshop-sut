# TC-COUPON-021: Nhập mã giảm giá có dấu cách ở cuối chuỗi
...
## Expected result
- Hệ thống tự động trim khoảng trắng ở cuối, áp dụng mã thành công. Trả về HTTP 200, giảm giá 30,000 VND.
