# FR04-N-BVA-TC06: Biên MAX của họ tên
...
| API field | `name` |
| Lớp/biên | MAX, độ dài 50 |
| Giá trị | `aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa` |
...
## Kết quả mong đợi
- Chấp nhận cập nhật; hồ sơ lưu/hiển thị họ tên 50 ký tự.
