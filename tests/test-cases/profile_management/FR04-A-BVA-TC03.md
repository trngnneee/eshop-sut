# FR04-A-BVA-TC03: Kiểm thử Địa chỉ giao hàng mặc định với độ dài Min+1 (6 ký tự)
...
| :--- | :--- |
| Địa chỉ giao hàng mặc định | AAAAAA |

## Test steps
1. Mở form FR-04.
2. Nhập Địa chỉ giao hàng mặc định có độ dài 6 ký tự.
3. Bấm nút Submit.
