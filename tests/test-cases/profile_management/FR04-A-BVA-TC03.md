# FR04-A-BVA-TC03: Biên MIN+1 của địa chỉ
...
## Expected result
- Chấp nhận cập nhật; hồ sơ lưu/hiển thị `shipping_address = "House1"`.

## Actual result
- Chấp nhận cập nhật; hồ sơ lưu/hiển thị `House1`.
