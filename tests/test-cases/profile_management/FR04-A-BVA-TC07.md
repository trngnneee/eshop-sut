# FR04-A-BVA-TC07: Biên MAX+1 của địa chỉ
...
| Lớp/biên | MAX+1, độ dài 256 |
| Giá trị | Chuỗi địa chỉ 256 ký tự |
...
## Expected result
- Từ chối cập nhật; hiển thị/trả về lỗi vượt quá độ dài tối đa; địa chỉ cũ không đổi.

## Actual result
- Hệ thống chấp nhận và lưu/hiển thị địa chỉ 256 ký tự.
