# FR04-P-BVA-TC01: Biên dưới MIN-1 của số điện thoại
...
## Expected result
- Từ chối cập nhật; hiển thị/trả về lỗi dưới độ dài tối thiểu; số điện thoại cũ không đổi.
