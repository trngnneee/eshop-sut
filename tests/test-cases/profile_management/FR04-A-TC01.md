# FR04-A-TC01: Cập nhật địa chỉ tiếng Việt hợp lệ
...
| Lớp/biên | A1 - Địa chỉ tiếng Việt hợp lệ |
| Giá trị | `12 Nguyễn Trãi, Phường Bến Thành, Quận 1` |
...
## Expected result
- Chấp nhận cập nhật; hồ sơ lưu/hiển thị `shipping_address = "12 Nguyễn Trãi, Phường Bến Thành, Quận 1"`.
