# FR04-N-TC01: Cập nhật họ tên tiếng Việt hợp lệ
...
| API field | `name` |
| Lớp/biên | N1 - Họ tên tiếng Việt hợp lệ |
| Giá trị | `Đặng Trường Nguyên` |
...
## Expected result
- Chấp nhận cập nhật; hồ sơ trả về/lưu `name = "Đặng Trường Nguyên"`.
