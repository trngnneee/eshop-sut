# FR04-P-BVA-TC04: Giá trị danh nghĩa của số điện thoại

## Requirement ID
FR-04

## Module / Loại test / Kỹ thuật
Profile Management - Số điện thoại / Functional / Phân tích giá trị biên (Boundary Value Analysis)
...
## Kết quả mong đợi
- Chấp nhận cập nhật; hồ sơ lưu/hiển thị `phone = "0912345678"`.

## Kết quả thực tế
- Bị từ chối với thông báo `Invalid phone number format`.
