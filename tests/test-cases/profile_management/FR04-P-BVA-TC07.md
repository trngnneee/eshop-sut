# FR04-P-BVA-TC07: Biên MAX+1 của số điện thoại
...
| API field | `phone` |
| Lớp/biên | MAX+1, độ dài 12 |
| Giá trị | `090123456789` |
...
## Kết quả mong đợi
- Từ chối cập nhật; hiển thị/trả về lỗi vượt quá độ dài tối đa; số điện thoại cũ không đổi.
