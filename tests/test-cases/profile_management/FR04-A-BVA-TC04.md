# FR04-A-BVA-TC04: Giá trị danh nghĩa của địa chỉ
...
| Lớp/biên | Nominal, độ dài 130 |
| Giá trị | Chuỗi địa chỉ 130 ký tự |
...
## Expected result
- Chấp nhận cập nhật; hồ sơ lưu/hiển thị địa chỉ 130 ký tự.
