...
| [TC-CART-011](../test-cases/cart/TC-CART-011.md) | Cart | AI Tester | Pass |  | Hệ thống không cộng dồn số lượng khi thêm sản phẩm trùng ID (BUG-FR07-B-03). |
| [TC-CART-012](../test-cases/cart/TC-CART-012.md) | Cart | AI Tester | Pass |  | Tạo dòng mới trùng lặp khi thêm cùng sản phẩm nhiều lần (BUG-FR07-B-03). |
...
| [TC-CART-042](../test-cases/cart/TC-CART-042.md) | Cart | AI Tester | Pass |  | Backend không cộng dồn số lượng sản phẩm trùng ID (BUG-FR07-B-02). |
...
| [TC-CART-076](../test-cases/cart/TC-CART-076.md) | Cart | AI Tester | Fail | BUG-FR07-B-17 | Giao diện cho phép nhấn thanh toán và redirect sang /checkout khi giỏ hàng trống. |
| [TC-CART-077](../test-cases/cart/TC-CART-077.md) | Cart | AI Tester | Fail | BUG-FR07-B-17 | Trang checkout hiển thị và chấp nhận thông tin sản phẩm có số lượng/đơn giá âm từ API. |
