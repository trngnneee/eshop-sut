# FR10-S-TC08: Từ chối Admin chuyển tắt pending sang shipping
...
| Thuộc tính | Giá trị |
| :--- | :--- |
| Transition / Class ID | S-INVALID-01 |
| State variable | `status` |
| Actor | admin |
| Flow type | Invalid transition |
| Covered guard/rule | Invalid transition: pending -> shipping skips confirmed |
...
- Execution interface: Local API `PUT /api/admin/orders/8/status` with SQLite fixture order `8`.
