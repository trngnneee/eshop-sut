Title: [BUG][Profile] Thiếu validate độ dài tối đa cho Số điện thoại (chấp nhận 12 chữ số)
...
2. Gửi request PUT đến endpoint `/api/users/me` với trường `phone: "091234567890"`:
   ```http
...
## Actual result
Hệ thống chấp nhận cập nhật, trả về HTTP 200 OK và lưu số điện thoại 12 số vào database.

## Evidence
![Ảnh lỗi API/Database](../bugs-screenshots/BUG-PROFILE-012.png)
